...
REPO_URL = 'https://github.com/drSilvioManuel/python-tdd.git'

def deploy(**kwargs):
    site_folder = '/home/{}/sites/{}'.format(env.user, kwargs['sitename'])
    source_folder = site_folder + '/source'
    _create_directory_structure_if_necessary(site_folder)
    _get_latest_source(source_folder)
    _update_settings(source_folder, kwargs['sitename'])
